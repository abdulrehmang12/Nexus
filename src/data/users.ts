...
export const entrepreneurs: Entrepreneur[] = [
  {
    ...
    startupName: 'TechWave Analytics',
    pitchSummary: 'Financial analytics platform helping SMBs make data-driven decisions.',
    fundingNeeded: '$1.5M',
    industry: 'FinTech',
...
export const investors: Investor[] = [
  {
    ...
    investmentInterests: ['FinTech', 'SaaS', 'Analytics'],
